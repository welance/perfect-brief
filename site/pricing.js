...
(function (root) {
  ...
  var FORMULAS = [
    { id: "score",    n: 1, name: "The score",         formula: "score = Σ weightᵢ × verdictᵢ  (weights sum to 100)",          plain: "How good a brief is: a weighted average over public, versioned rules.",                                     source: "perfect_brief/scoring.yaml", url: "https://github.com/welance/perfect-brief/blob/main/perfect_brief/scoring.yaml" },
    { id: "gate",     n: 2, name: "The gate",          formula: "publish ⇔ every hard requirement holds",                       plain: "Whether a brief may publish at all — no average can paper over a hard miss.",                              source: "perfect_brief/scoring.yaml", url: "https://github.com/welance/perfect-brief/blob/main/perfect_brief/scoring.yaml" },
    { id: "coverage", n: 3, name: "Coverage",          formula: "coverage = Σ wᵢ × agreedᵢ / Σ wᵢ",                             plain: "How much of a role someone covers, part by part, agreed by both views.",                                   source: "PERFECT-PRICE.md §4", url: "https://github.com/welance/perfect-brief/blob/main/docs/perfect-price/PERFECT-PRICE.md#4-deriving-the-level-decompose-the-role" },
    { id: "share",    n: 4, name: "The share",         formula: "share = 30% + 0.4 × coverage",                                 plain: "The slice of the client rate that goes to the person — it follows from coverage, nothing else.",           source: "PERFECT-PRICE.md §3", url: "https://github.com/welance/perfect-brief/blob/main/docs/perfect-price/PERFECT-PRICE.md#3-the-rule" },
